          ...
          <form onSubmit={handleSubmit} className="space-y-6" id="login-form">
            <div className="relative" ref={emailInputRef}>
              ...
              <input 
                ...
                className="w-full px-5 py-4 rounded-2xl border border-gray-100 bg-gray-50/30 focus:ring-2 focus:ring-brand-500 outline-none transition font-medium text-gray-700"
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full px-5 py-4 rounded-2xl border border-gray-100 bg-gray-50/30 focus:ring-2 focus:ring-brand-500 outline-none transition pr-12 font-medium text-gray-700"
            ...
            <button type="submit" disabled={isSubmitting} className="w-full bg-[#84cc16] hover:bg-brand-600 text-white font-black py-5 rounded-2xl shadow-lg transition transform active:scale-95 uppercase tracking-widest text-sm disabled:opacity-50">
              {isSubmitting ? <i className="fas fa-spinner fa-spin"></i> : 'ENTRAR NO BORA ALUGAR'}
            </button>
          </form>
